...
public: 
  sensor::Sensor *comfoair_fan_supply_air_percentage{nullptr};
  sensor::Sensor *comfoair_fan_exhaust_air_percentage{nullptr};
  sensor::Sensor *comfoair_fan_speed_supply{nullptr};
  sensor::Sensor *comfoair_fan_speed_exhaust{nullptr};
  sensor::Sensor *comfoair_outside_air_temperature{nullptr};
  sensor::Sensor *comfoair_supply_air_temperature{nullptr};
  sensor::Sensor *comfoair_return_air_temperature{nullptr};
  sensor::Sensor *comfoair_exhaust_air_temperature{nullptr};
  sensor::Sensor *comfoair_enthalpy_temperature{nullptr};
  sensor::Sensor *comfoair_ewt_temperature{nullptr};
  sensor::Sensor *comfoair_reheating_temperature{nullptr};
  sensor::Sensor *comfoair_kitchen_hood_temperature{nullptr};
  sensor::Sensor *comfoair_return_air_level{nullptr};
  sensor::Sensor *comfoair_supply_air_level{nullptr};
  sensor::Sensor *comfoair_bypass_factor{nullptr};
  sensor::Sensor *comfoair_bypass_step{nullptr};
  sensor::Sensor *comfoair_bypass_correction{nullptr};
  binary_sensor::BinarySensor *comfoair_is_bypass_valve_open{nullptr};
  binary_sensor::BinarySensor *comfoair_is_preheating{nullptr};
  binary_sensor::BinarySensor *comfoair_is_summer_mode{nullptr};
  binary_sensor::BinarySensor *comfoair_is_supply_fan_active{nullptr};
  binary_sensor::BinarySensor *comfoair_is_filter_full{nullptr};

  void set_fan_supply_air_percentage(sensor::Sensor *comfoair_fan_supply_air_percentage) {this->comfoair_fan_supply_air_percentage = comfoair_fan_supply_air_percentage;};
  void set_fan_exhaust_air_percentage(sensor::Sensor *comfoair_fan_exhaust_air_percentage) {this->comfoair_fan_exhaust_air_percentage = comfoair_fan_exhaust_air_percentage; };
  void set_fan_speed_supply(sensor::Sensor *comfoair_fan_speed_supply) {this->comfoair_fan_speed_supply = comfoair_fan_speed_supply; };
  void set_fan_speed_exhaust(sensor::Sensor *comfoair_fan_speed_exhaust) {this->comfoair_fan_speed_exhaust = comfoair_fan_speed_exhaust; };
  void set_is_bypass_valve_open(binary_sensor::BinarySensor *comfoair_is_bypass_valve_open) {this->comfoair_is_bypass_valve_open = comfoair_is_bypass_valve_open; };
  void set_is_preheating(binary_sensor::BinarySensor *comfoair_is_preheating) {this->comfoair_is_preheating = comfoair_is_preheating; };
  void set_outside_air_temperature(sensor::Sensor *comfoair_outside_air_temperature) {this->comfoair_outside_air_temperature = comfoair_outside_air_temperature; };
  void set_supply_air_temperature(sensor::Sensor *comfoair_supply_air_temperature) {this->comfoair_supply_air_temperature = comfoair_supply_air_temperature; };
  void set_return_air_temperature(sensor::Sensor *comfoair_return_air_temperature) {this->comfoair_return_air_temperature = comfoair_return_air_temperature; };
  void set_exhaust_air_temperature(sensor::Sensor *comfoair_exhaust_air_temperature) {this->comfoair_exhaust_air_temperature = comfoair_exhaust_air_temperature; };
  void set_enthalpy_temperature(sensor::Sensor *comfoair_enthalpy_temperature) {this->comfoair_enthalpy_temperature = comfoair_enthalpy_temperature; };
  void set_ewt_temperature(sensor::Sensor *comfoair_ewt_temperature) {this->comfoair_ewt_temperature = comfoair_ewt_temperature; };
  void set_reheating_temperature(sensor::Sensor *comfoair_reheating_temperature) {this->comfoair_reheating_temperature = comfoair_reheating_temperature; };
  void set_kitchen_hood_temperature(sensor::Sensor *comfoair_kitchen_hood_temperature) {this->comfoair_kitchen_hood_temperature = comfoair_kitchen_hood_temperature; };
  void set_return_air_level(sensor::Sensor *comfoair_return_air_level) {this->comfoair_return_air_level = comfoair_return_air_level; };
  void set_supply_air_level(sensor::Sensor *comfoair_supply_air_level) {this->comfoair_supply_air_level = comfoair_supply_air_level; };
  void set_is_supply_fan_active(binary_sensor::BinarySensor *comfoair_is_supply_fan_active) {this->comfoair_is_supply_fan_active = comfoair_is_supply_fan_active; };
  void set_is_filter_full(binary_sensor::BinarySensor *comfoair_is_filter_full) {this->comfoair_is_filter_full = comfoair_is_filter_full; };
  void set_bypass_factor(sensor::Sensor *comfoair_bypass_factor) {this->comfoair_bypass_factor = comfoair_bypass_factor; };
  void set_bypass_step(sensor::Sensor *comfoair_bypass_step) {this->comfoair_bypass_step = comfoair_bypass_step; };
  void set_bypass_correction(sensor::Sensor *comfoair_bypass_correction) {this->comfoair_bypass_correction = comfoair_bypass_correction; };
  void set_is_summer_mode(binary_sensor::BinarySensor *comfoair_is_summer_mode) {this->comfoair_is_summer_mode = comfoair_is_summer_mode; };
};
